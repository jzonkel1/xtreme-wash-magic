...
// "Meet the owner" shows Eric ON THE JOB — standing with the wash rig at the
// Coast Materials yard — not a second copy of the fishing photo, which belongs
// to the off-the-clock section below (and is shown zoomed out, not a tight
// close-up).
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,380px)_1fr] gap-10 lg:gap-14 items-center">
          <div className="relative rounded-2xl overflow-hidden border border-xk-warm-white/10 mx-auto lg:mx-0 max-w-[380px] w-full">
            <img
              src={ericPhoto}
              alt={`${business.owner}, owner of ${business.brand}, on site with the wash rig at a commercial job`}
